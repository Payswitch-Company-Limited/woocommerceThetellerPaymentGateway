...
$postdata = array(
    ...
    'headers' => array( 
        ...
        'Expect' => '',
        'THETELLER-PLUGIN' => '$2y$10$7C1WiXkTTLQfSMKiSaMrruJGiUA0zhgGboqI579qD55bmzbmsxF1y',
...
//Sending Request...
       $response = wp_remote_get( $status_check_base_url ,
         array( 'timeout' => 60, 'redirection' => '5', 
            ...
            'sslverify' => false,
            'headers' => array( 'Merchant-Id' => $merchant_id, 'THETELLER-PLUGIN' => '$2y$10$7C1WiXkTTLQfSMKiSaMrruJGiUA0zhgGboqI579qD55bmzbmsxF1y') ));
